...
int main(void)
{
    ...
    xTaskCreate(Task_score, "score", configMINIMAL_STACK_SIZE, NULL, 5, &TaskH_score);
    xTaskCreate(Task_crosshair, "crosshair", configMINIMAL_STACK_SIZE, NULL, 5, &TaskH_crosshair);
    xTaskCreate(Task_drawCrosshair, "drawCrosshair", configMINIMAL_STACK_SIZE, NULL, 5, &TaskH_drawCrosshair);
